...
public class ProdutoRepository {
    ...
    public ProdutoRepository(){
        ...
        hm.put(4, new Produto(4, "Don't starve Together", 25, 67));
        ...
        hm.put(10, new Produto(10, "The Legend of Zelda: Breath Of The Wild", 230, 1));
    } 

    //Testar com int, se der erro mudar para Integer (argumento)
    public Produto getProdutoById(Integer cod){
        return hm.get(cod);
    }
